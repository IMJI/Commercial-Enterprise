...
import {
	...
	outgoingQueryScheme
} from '../../validation/OutgoingValidation';
...
outgoingRouter
	...
	.get(
		...
		(req, res, next) => {
			outgoingController.get(req, res, next);
		}
	)
	.post(
		outgoingValidation,
		...
		(req, res, next) => {
			outgoingController.post(req, res, next);
		}
	)
	.put(
		outgoingValidation,
		...
		(req, res, next) => {
			outgoingController.put(req, res, next);
		}
	)
	.delete(
		outgoingValidation,
		...
		(req, res, next) => {
			outgoingController.delete(req, res, next);
		}
	);
