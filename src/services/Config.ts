...
class Config {
    ...
    static get WebServer() : WebServerConfig { return this.webServerConfig }
    private static databaseConfig : DatabaseConfig;
    static get Database() : DatabaseConfig { return this.databaseConfig }
    private static loggerConfig : LoggerConfig;
    static get Logger() : LoggerConfig { return this.loggerConfig }
    private static cacheConfig : CacheConfig;
    static get Cache() : CacheConfig { return this.cacheConfig }
